...
if __name__ == '__main__':
    ...
    for i in range(100):
        ...
        speaker.play(gpio.tones.Tone(37))
        speaker.play(gpio.tones.Tone(40))
        speaker.play(gpio.tones.tone(42))
        speaker.play(gpio.tones.Tone(39))
        speaker.play(gpio.tones.Tone(35))
        speaker.play(gpio.tones.Tone(39))
        speaker.play(gpio.tones.Tone(40))
        speaker.play(gpio.tones.Tone(33))
